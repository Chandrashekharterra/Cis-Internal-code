...
import { FirstLevelExaminationComponent } from './examination/first-level-examination/first-level-examination/first-level-examination.component';
import { QuestionService } from './examination/first-level-examination/first-level-examination/question.service';
import { PopUpComponent } from './examination/pop-up/pop-up.component';
import { ChildComponent } from './examination/child/child.component';
...
@NgModule({
    declarations: [
        AppComponent,
        FullComponent,
        FirstLevelExaminationComponent,
        AppHeaderComponent,
        SpinnerComponent,
        AppBlankComponent,
        AppSidebarComponent,
